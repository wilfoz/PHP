...
$app->post("/register", function(){
	...
	if (!isset($_POST['name']) || $_POST['name'] == '') {
		$msg = User::setErrorRegister("Preencha o seu nome.");
	...
	if (!isset($_POST['email']) || $_POST['email'] == '') {
		$msg = User::setErrorRegister("Preencha o seu email.");
	...
	if (!isset($_POST['password']) || $_POST['password'] == '') {
		$msg = User::setErrorRegister("Preencha a senha.");
	...
	if (User::checkLoginExist($_POST['email']) == true) {
		$msg = User::setErrorRegister("Este email ja esta sendo usado.");
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["endereco2"] = $order->getdescity()." ".$order->getdesstate()." ".$order->getdeszicode();
...
$app->post("/profile/change-password", function(){
	...
	if (!password_verify($_POST['current_pass'], $user->getdespassword())) {
		User::setError("A sua senha esta invalida.");
		header("Location: /profile/change-password");
		exit;
	}
